...
__author__ = 'JAI_GANESH'



from collections import Counter

def MostFamousProduct(brands):
    brandCounts=Counter(brands)
    final=brandCounts.most_common(1)
    print(final)
    for k,v in final:
        print(k)

userInput=int(raw_input("User!!! enter the iteration you wanna do:"))
coll=[]
for i in range(userInput):
    i=raw_input()
    coll.append(i)
    
MostFamousProduct(coll)
